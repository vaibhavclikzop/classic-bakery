                                     ...
                                     <li
                                         ...
                                         <ul
                                             ...
                                             <li><a href="/advance-order-list/invoices"
                                                     class="{{ Request::is('advance-order-list/invoice') ? 'active' : '' }}">Invoices</a>
                                             </li>
                                 ...
                                 @if ($rolePermissions->where('permission_id', 22)->where('view', 1)->isNotEmpty())
                                     <li
                                         ...
                                         <ul
                                             ...
                                             <li><a href="/reports/po-generated-report"
                                                     class="{{ Request::is('reports/po-generated-report') ? 'active' : '' }}">
                                                     PO Generated Report</a></li>

                                             <li><a href="/reports/rm-purchase-history-report"
                                                     class="{{ Request::is('reports/rm-purchase-history-report') ? 'active' : '' }}">
                                                     Rm Purchase History Report</a></li>

                                             <li><a href="/reports/department-sale-report"
                                                     class="{{ Request::is('reports/department-sale-report') ? 'active' : '' }}">
                                                     Department Sale Report</a></li>
                                 ...
                                 @if ($rolePermissions->where('permission_id', 22)->where('view', 1)->isNotEmpty())
                                     <li
                                         ...
                                         <ul
                                             ...
                                             <li><a href="/sale-report"
                                                     class="{{ Request::is('sale-report') ? 'active' : '' }}">Sale
                                                     Report</a></li>
