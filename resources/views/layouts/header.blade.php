                                 ...
                                 @foreach ($rolePermissions as $item)
                                     @if ($item->permission_id == 1 && $item->view == 1)
                                         ...
                                         <li class="{{ Request::is('department') ? 'active' : '' }}"><a
                                                 href="/department"><i
                                                     data-feather="home"></i><span>Department</span></a>
                                         </li>
                                     @endif
                             ...
                             <ul>
                                 ...
                                 <li class="submenu">
                                     ...
                                     <ul
                                         ...
                                         <li><a href="/unit-type"
                                                 class="{{ Request::is('unit-type') ? 'active' : '' }}">Unit Type</a>
                                         </li>
                                         <li><a href="/gst"
                                                 class="{{ Request::is('gst') ? 'active' : '' }}">GST</a></li>
                                         <li><a href="/outlet"
                                                 class="{{ Request::is('outlet') ? 'active' : '' }}">Outlet</a></li>
                                 ...
                                 <li class="{{ Request::is('vendor') ? 'active' : '' }}"><a href="/vendor">
                                         <i class="fa fa-users" aria-hidden="true"></i> &nbsp; &nbsp; <span> Vendor
                                         </span></a>
                                 </li>
                             ...
                             <ul>
                                 ...
                                 <li
                                     ...
                                     <a href="javascript:void(0);"
                                         ...
                                         <i class="fa-solid fa-person-walking-luggage"></i> &nbsp; &nbsp; <span>Outward
                                 ...
                                 <li
                                     ...
                                     <ul
                                         ...
                                         <li><a href="/audit-setting"
                                                 class="{{ Request::is('audit-setting') ? 'active' : '' }}">RM Audit
                                                 Settings</a></li>
                                         <li><a href="/audit-report"
                                                 class="{{ Request::is('audit-report') ? 'active' : '' }}">RM Audit
                                                 Report</a></li>
