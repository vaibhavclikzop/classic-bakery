...
@section('main-section')
    @push('title')
        <title>Audit Setting Finish Goods</title>
    @endpush
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <div class="page-title">
                <h4>Audit Setting Finish Goods</h4>
            </div>
            <div class="">
        ...
        <div class="card-body">
            ...
            <form action="" class="row" method="GET">
                <div class="col-md-4">
                    ...
                    <select class="form-control" name="outlet_id" id="outlet_id" required onchange="this.form.submit()">
            ...
            <form method="POST" action="{{ route('SaveOutletAuditReport') }}" class="row needs-validation" novalidate
