        ...
        <div>
            <div>
                <form action="" class="d-flex">
                    ...
                    <div>
                        <div>
                            <button id="exportToExcel" data-name="Invoices"
                                class="btn btn-success float-end btn-sm mx-2">Export to Excel
                            </button>
                        </div>
                    </div>
                </form>
        ...
        <table class="table dataTable" id="exportTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/pos-order-view/{{$item->id}}" class="btn btn-sm btn-outline-primary">
                            {{ $item->invoice_no }}
                        </a>
                    </td>
                    <td>{{ $item->name }}</td>
