    ...
    <div class="card">
        ...
        <div class="card-body" id="PrintOrder">
            ...
            @foreach ($invoices as $invoice)
                @php
                    $order_mst = $invoice['order_mst'];
                    $order_det = $invoice['order_det'];
                @endphp
                @if ($invoice['order_type'] == 'Regular Order')
                    <div style="margin-top: 10px; border: solid 1px; padding:5px;">
                        <div>
                    ...
                    <div>
                            ...
                            <table class="w-100">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($order_det as $item)
                                        ...
                                        @endphp
                                        <tr>
                                            <td style="border:  solid 1px; padding:2px; font-size:11px">{{ $sno++ }}
                                            </td>
                                            ...
                                            <td style="border:  solid 1px; padding:2px; font-size:11px">{{ $item->uom }}
                                            </td>
                                            <td style="border:  solid 1px; padding:2px; font-size:11px">
                                                {{ formatQtyPrice($item->mrp) }}</td>

                                            <td style="border:  solid 1px; padding:2px; font-size:11px">
                                                {{ formatQtyPrice($item->qty) }}</td>
                                            <td style="border:  solid 1px; padding:2px; font-size:11px">{{ $rate }}
                                            </td>
                                            <td style="border:  solid 1px; padding:2px; font-size:11px">
                                                {{ $taxable }}
                                            </td>
                                            <td style="border:  solid 1px; padding:2px; font-size:11px">
                                                {{ formatQtyPrice($item->gst) }} </td>
                                            <td style="border:  solid 1px; padding:2px; font-size:11px">
                                                {{ $gst }}
                                            </td>
                                            <td style="border:  solid 1px; padding:2px; font-size:11px">
                                                {{ formatQtyPrice($item->cess_amt) }} </td>
                                            <td style="border:  solid 1px; padding:2px; font-size:11px">
                                                {{ $cess }}
                                            </td>
                                            <td style="border:  solid 1px; padding:2px; font-size:11px">
                                ...
                                <tfoot>
                                    <tr>
                                        <th style="border:  solid 1px; padding:2px; font-size:11px" colspan="5">Total
                                        </th>
                                        <th style="border:  solid 1px; padding:2px; font-size:11px">
                                            {{ formatQtyPrice($qty) }}
                                        </th>
                                        <th style="border:  solid 1px; padding:2px; font-size:11px"></th>
                                        <th style="border:  solid 1px; padding:2px; font-size:11px">
                                            {{ formatQtyPrice($total_taxable) }}</th>
                                        <th style="border:  solid 1px; padding:2px; font-size:11px"></th>
                                        <th style="border:  solid 1px; padding:2px; font-size:11px">
                                            {{ formatQtyPrice($total_gst) }}
                                        </th>
                                        <th style="border:  solid 1px; padding:2px; font-size:11px"></th>
                                        <th style="border:  solid 1px; padding:2px; font-size:11px">
                                            {{ formatQtyPrice($total_cess) }}
                                        </th>
                                        <th style="border:  solid 1px; padding:2px; font-size:11px">
                                            {{ formatQtyPrice($gross_total) }}
                                        </th>
                                    </tr>
                                </tfoot>
                        ...
                        <div style="display: flex; justify-content: space-between;  ">
                            <div style="padding: 5px; border:solid 1px; width: 50%">
                                <table class="w-100">
                                    <tr>
                                        <th style="border:  solid 1px; padding:2px; font-size:11px" colspan="2">In Words
                                            :
                                        </th>
                                    </tr>
                                    <tr>
                                        <th style="border:  solid 1px; padding:2px; font-size:11px" colspan="2">Bank
                                            Details
                                            :
                                        </th>
                                    </tr>
                                    ...
                                    <tr>
                                        <th style="border:  solid 1px; padding:2px; font-size:11px">Bank Account Number
                                        </th>
                                        <th style="border:  solid 1px; padding:2px; font-size:11px">NA</th>
                                    </tr>
                                    <tr>
                            ...
                            <div style="padding: 5px; border:solid 1px; width: 50%">
                                <table class="w-100" style="text-align: right">
                                    <tr>
                                        <th style="border:  solid 1px; padding:2px; font-size:11px">Total Amount Before Tax
                                        </th>
                                        <th style="border:  solid 1px; padding:2px; font-size:11px">
                                            {{ formatQtyPrice($total_taxable) }}</th>
                                    </tr>
                ...
                @elseif ($invoice['order_type'] == 'Advance Order')
                    <div class="" id="" style="margin-top: 10px; border: solid 1px; padding:5px;">
                            ...
                            <table class="w-100">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($order_det as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td style="border:  solid 1px; padding:2px">{{ $item->product }},
                                                {{ $item->weight }} KG
                                            ...
                                            <td style="border:  solid 1px; padding:2px">{{ formatQtyPrice($item->qty) }}
                                            </td>
                                            <td style="border:  solid 1px; padding:2px">{{ $rate }}</td>
                                            <td style="border:  solid 1px; padding:2px">
                                                {{ $taxable }}
                                            </td>
                                            <td style="border:  solid 1px; padding:2px">{{ formatQtyPrice($item->gst) }}
                                            </td>
                                            <td style="border:  solid 1px; padding:2px">
                                                {{ $gst }}
                                            </td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th style="border:  solid 1px; padding:2px">{{ formatQtyPrice($total_taxable) }}
                                        </th>
                                        <th style="border:  solid 1px; padding:2px"></th>
                                        ...
                                        <th style="border:  solid 1px; padding:2px">{{ formatQtyPrice($gross_total) }}
                                        </th>
                                    </tr>
                                </tfoot>
                            ...
                            <div style="padding: 5px; border:solid 1px; width: 50%">
                                <table class="w-100" style="text-align: right">
                                    ...
                                    <tr>
                                        ...
                                        <th style="border:  solid 1px; padding:2px">{{ formatQtyPrice($total_cess) }}
                                        </th>
                                    </tr>
                                    <tr>
