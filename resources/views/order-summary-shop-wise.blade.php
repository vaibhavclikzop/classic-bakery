...
@section('main-section')
  ...
  @php
    $grouped = $work_order_det
        ->sortBy('sub_category')   // ascending order
...
<div style="display:flex;gap:20px;align-items:flex-start;">
    ...
    <div style="width:50%;">
        ...
        @foreach ($left as $items)
            @php 
                $category = $items->first()->sub_category; 
                $total = 0;
            @endphp
            ...
            <div style="margin-bottom:15px;">
                ...
                <table style="width:100%; border-collapse:collapse; border:1px solid #635e5e;">
