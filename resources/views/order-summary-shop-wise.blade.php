                    ...
                    <div style="margin-bottom:15px;">
                        ...
                        <table class="report-table" style="width:100%; border-collapse:collapse; border:1px solid #635e5e;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="border:1px solid #635e5e; font-size: 11px">{{ $item->product }}</td>
                                ...
                                <tr>
                                    <td style="text-align:right; border:1px solid #635e5e;font-size: 11px"><b>Total</b></td>
                                    <td style="text-align:center; border:1px solid #635e5e;font-size: 11px"><b>{{ number_format($total,2) }}</b></td>
                                    <td style="border:1px solid #635e5e;font-size: 11px"></td>
                                </tr>
                        ...
                        <table class="report-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td  style="text-align:center; border:1px solid #635e5e;font-size: 11px"></td>
                                </tr>
