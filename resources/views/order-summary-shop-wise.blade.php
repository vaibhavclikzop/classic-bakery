                        ...
                        @foreach ($left as $category => $items)
                            <div style="margin-bottom:15px;">
                                ...
                                <table class="report-table"
                                    style="width:100%; border-collapse:collapse; border:1px solid #635e5e;">

                                    <thead>
                                        <tr>
                                            <th style="width:60%; border:1px solid #635e5e;">Product</th>
                                            <th style="width:20%; text-align:center; border:1px solid #635e5e;">Order Qty
                                            </th>
                                            <th style="width:20%; text-align:center; border:1px solid #635e5e;">Actual Qty
                                            </th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($items as $item)
                                            <tr>
                                                <td
                                                    style="border:1px solid #635e5e; font-size:11px; width:100px; word-break:break-word;">
                                                    {{ $item->product }}
                                                </td>

                                                <td style="text-align:center; border:1px solid #635e5e;font-size: 11px">
                                                    {{ formatQtyPrice($item->qty) }}
                                                </td>
                                                <td style="border:1px solid #635e5e;font-size: 11px"></td>
                                            </tr>
                                        ...
                                        <tr>
                                            <td style="text-align:right; border:1px solid #635e5e;font-size: 11px">
                                                <b>Total</b>
                                            </td>
                                            <td style="text-align:center; border:1px solid #635e5e;font-size: 11px">
