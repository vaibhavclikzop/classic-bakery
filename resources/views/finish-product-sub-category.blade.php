...
@section('main-section')
    @push('title')
        <title>Finish Product Sub Category</title>
    @endpush
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <div class="page-title">
                <h4>Finish Product Sub Category</h4>
            </div>
            <div class="">
                    ...
                    @foreach ($sub_category as $item)
                        <tr>
                            ...
                            <td><button class="btn btn-primary btn-sm edit" type="button" data-id="{{ $item->id }}"
                                    data-name="{{ $item->name }}" data-category_id="{{ $item->f_category_id }}"
    ...
    <div class="modal fade" id="exampleModal">
        <div class="modal-dialog">
            <form class="row g-3 needs-validation" novalidate method="POST"
                action="{{ route('SaveFinishProductSubCategory') }}">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body row">
                        ...
                        <div class="col-md-12 mt-4">
                            ...
                            <select name="f_category_id" id="f_category_id" class="form-control" required>
    ...
    <script>
        $(document).on("click", ".edit", function() {
            ...
            $("#f_category_id").val($(this).data("category_id"));
