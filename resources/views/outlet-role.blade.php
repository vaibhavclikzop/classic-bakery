...
@section('main-section')
                    ...
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td><button class="btn btn-primary btn-sm edit" type="button" data-id="{{ $item->id }}"
                                ...
                                <a class="btn btn-sm btn-info" href="/outlet-user-permission/{{ $item->id }}"><i
    ...
    <div class="modal fade" id="exampleModal">
        <div class="modal-dialog">
            <form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('SaveOutletRole') }}">
                @csrf
