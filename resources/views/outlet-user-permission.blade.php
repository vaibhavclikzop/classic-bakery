...
@section('main-section')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('SaveOutletUserPermission') }}" method="POST" class="needs-validation" novalidate>
                @csrf
                <table class="table">
                    <input type="hidden" name="outlet_role_id" value="{{ $id }}">
                    <tbody>
                        <tr>
                            <td>
                                <label for="">Select Permission</label>
                                <select name="outlet_permission_id" id="outlet_permission_id" class="form-control" required>
   ...
   <form action="{{ route('RemoveOutletPermission') }}" method="POST">
    @csrf
